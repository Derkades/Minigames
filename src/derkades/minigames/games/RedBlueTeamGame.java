...
public abstract class RedBlueTeamGame<MapType extends GameMap> extends TeamGame<MapType> {
	...
	public RedBlueTeamGame(@NotNull String identifier, @NotNull String name, @NotNull String@NotNull[] description,
						   @NotNull Material material, @NotNull MapType@NotNull[] gameMaps, int requiredPlayers,
						   int duration, @NotNull Set<GameLabel> gameLabels) {
		super(identifier, name, description, material, gameMaps, requiredPlayers, duration, gameLabels, RED_AND_BLUE);
	}
